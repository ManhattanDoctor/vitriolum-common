...
export type AiImageTaskProgress = IOpenAiImageProgress | IGigaChatImageProgress;

export type AiImageTaskResponse = IOpenAiImageResponse | IGigaChatImageResponse;

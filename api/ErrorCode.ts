...
export enum ErrorCode {
    ...
    AI_TASK_COST_EXCEED = 'AI_TASK_COST_EXCEED',

    AI_MODEL_NOT_FOUND = 'AI_MODEL_NOT_FOUND',
    AI_MODEL_NOT_SUPPORT_FILE = 'AI_MODEL_NOT_SUPPORT_FILE',
    AI_PRICE_NOT_FOUND = 'AI_PRICE_NOT_FOUND',
    AI_RATE_NOT_FOUND = 'AI_RATE_NOT_FOUND',
    ...
    FILE_DIRECTORY_ALREADY_EXISTS = 'FILE_DIRECTORY_ALREADY_EXISTS',
    
    AGENT_NOT_FOUND = 'AGENT_NOT_FOUND',
    AGENT_FORBIDDEN = 'AGENT_FORBIDDEN',

    AGENT_GRAPH_NOT_FOUND = 'AGENT_GRAPH_NOT_FOUND',
    AGENT_GRAPH_FORBIDDEN = 'AGENT_GRAPH_FORBIDDEN',
    AGENT_GRAPH_INVALID = 'AGENT_GRAPH_INVALID',
    AGENT_GRAPH_PROBLEMS = 'AGENT_GRAPH_PROBLEMS',
    AGENT_GRAPH_RUN_NOT_FOUND = 'AGENT_GRAPH_RUN_NOT_FOUND',
    AGENT_GRAPH_RUN_NOT_AWAITING = 'AGENT_GRAPH_RUN_NOT_AWAITING',
    AGENT_GRAPH_COST_EXCEED = 'AGENT_GRAPH_COST_EXCEED',
    AGENT_GRAPH_STEPS_EXCEED = 'AGENT_GRAPH_STEPS_EXCEED',
    ...
    MCP_SERVER_FORBIDDEN = 'MCP_SERVER_FORBIDDEN',
    MCP_SERVER_UID_INVALID = 'MCP_SERVER_UID_INVALID',
    MCP_SERVER_UID_ALREADY_EXISTS = 'MCP_SERVER_UID_ALREADY_EXISTS'
}
